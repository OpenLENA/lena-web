...
PROJECT_WORK_SRC_PATH=${CONNECTOR_SRC_PATH}
PROJECT_WORK_TMP_PATH=${PROJECT_TARGET_PATH}/temp
############  End of setting default path  ############

############ Start of generating src files ############
info_emphasized "${PROJECT_NAME} : generating src files..."
gen_web_connectors_src ${PROJECT_SRC_PATH} ${PROJECT_WORK_SRC_PATH} ${PROJECT_WORK_TMP_PATH}
############  End of generating src files  ############


############ Start of compile ############
info_emphasized "${PROJECT_NAME} : compile..."
compile_web_connectors ${PROJECT_WORK_SRC_PATH} ${WEB_ENGINE_TARGET_PATH}
check_exit_code $?
############  End of compile  ############
